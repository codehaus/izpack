...
import static com.izforge.izpack.panels.userinput.rule.rule.FieldSpec.Type;
import static com.izforge.izpack.panels.userinput.rule.rule.FieldSpec.Type.ALPHA;
import static com.izforge.izpack.panels.userinput.rule.rule.FieldSpec.Type.ALPHANUMERIC;
import static com.izforge.izpack.panels.userinput.rule.rule.FieldSpec.Type.NUMERIC;
import static com.izforge.izpack.panels.userinput.rule.rule.FieldSpec.Type.OPEN;
...
public class FieldLayoutTest
{
    ...
    public void testInvalidLayout()
    {
        ...
        FieldLayout layout2 = new FieldLayout("N:1::");
        checkLayout(layout2, "N:1::");

        FieldLayout layout3 = new FieldLayout("Q:5:5");
        checkLayout(layout3, "Q:5:5");
    }
