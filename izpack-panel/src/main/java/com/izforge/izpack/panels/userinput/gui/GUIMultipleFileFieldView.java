 ...
 * @author Tim Anderson
 */
public class GUIMultipleFileFieldView extends GUIFieldView
{
    ...
    /**
     * Constructs a {@code GUIMultipleFileFieldView}.
     *
     * @param field       the field
     * @param installData the installation data
     * @param parent      the parent frame
     */
    public GUIMultipleFileFieldView(MultipleFileField field, GUIInstallData installData, InstallerFrame parent)
    {
        super(field);
        List<ValidatorContainer> validators = getValidatorContainers();
        fileInput = new MultipleFileInputField(field, parent, installData, false, validators);
