 ...
 * @author Tim Anderson
 */
public class GUITitleFieldView extends GUIFieldView
{

    /**
     * The logger.
     */
    private static final Logger logger = Logger.getLogger(GUITitleFieldView.class.getName());

    /**
     * Constructs a  {@code GUITitleFieldView}.
     *
     * @param field       the field
     * @param installData the installation data
     * @param icons       the icons
     */
    public GUITitleFieldView(TitleField field, InstallData installData, IconsDatabase icons)
    {
        super(field);
