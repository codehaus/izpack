 ...
 * @author Tim Anderson
 */
public class GUIRadioFieldView extends GUIFieldView
{
    /**
     * The choices.
     */
    ...
    /**
     * Constructs a {@code GUIRadioFieldView}.
     *
     * @param field       the field
     * @param installData the installation data
     */
    public GUIRadioFieldView(RadioField field, InstallData installData)
    {
        super(field);
