...
public class FieldSpec
{
    ...
    public FieldSpec(String spec)
    {
        ...
        if (tokens == MAX_TOKENS)
        {
            ...
            {
                editLength = getEditLength(token, spec);
            }
        }
        else
        {
     ...
     *
     * @return {@code true} if the field has unlimited length, {@code false} if it is limited by {@link #getEditLength}
     */
    ...
    public boolean validate(String value)
    {
        ...
        if (value != null)
        {
            if (getUnlimitedEdit() || value.length() <= editLength)
            {
     ...
     */
    private int getColumns(String size, String spec)
    {
        int result;
        try
        {
     ...
     * Returns the size of the field.
     *
     * @param value the size as a string
     * @param spec  the rule, for error reporting purposes
     * @return the corresponding size
     */
    private int getEditLength(String value, String spec)
    {
        int result;
        try
        {
        ...
        {
            throw new IzPackException("Unable to determine the edit length of the field in rule:" + spec,
                                      exception);
        }
        return result;
    }
