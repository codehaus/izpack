...
public class ConsoleReader
{
    ...
    private String stripAnsi(String str) {
        if (str == null) return "";
        AnsiOutputStream aos = null;
        try {
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            aos = new AnsiOutputStream(baos);
    ...
    final String finishBuffer() throws IOException { // FIXME: Package protected because used by tests
        ...
        if (expandEvents) {
            try {
                ...
                logger.log(Level.FINE, "Could not expand event", e);
                beep();
                buf.clear();
                str = "";
            }
...
//        flush();
    ...
    public boolean paste() throws IOException {
        ...
        try {
            ...
            logger.log(Level.FINE, "Paste failed: ", e);
