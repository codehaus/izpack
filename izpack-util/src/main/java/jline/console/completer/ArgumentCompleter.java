...
{
    private static final Logger logger = Logger.getLogger(ArgumentCompleter.class.getName());
    ...
    public int complete(final String buffer, final int cursor, final List<CharSequence> candidates) {
        ...
        logger.finer("Completing " + buffer + " (pos=" + cursor + ") with: " + candidates + ": offset=" + pos);
